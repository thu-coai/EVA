...
CKPT_PATH="/dataset/f1d6ea5b/gyx-eva/eva2/results/finetune_with_pretrain_0.00005_128_1/35000"
...
CMD="/opt/conda/bin/deepspeed -i cgpt-m0:1 --master_port 1225 --hostfile ${HOST_FILE} ${WORKING_DIR}/src/eva_interactive.py ${OPTS}"
