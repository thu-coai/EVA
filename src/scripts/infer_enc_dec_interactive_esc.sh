...
# CKPT_PATH="/dataset/f1d6ea5b/gyx-eva/eva2/results/finetune_with_pretrain_0.00005_32_1_esc_blender_9_16_256/"
# CKPT_PATH="/dataset/f1d6ea5b/gyx-eva/eva2/results/finetune_with_pretrain_0.00005_32_1_esc_ft_9_16_256"
# CKPT_PATH="/dataset/f1d6ea5b/gyx-eva/eva2/results/finetune_with_pretrain_0.00005_32_1_esc_merge_9_17"
CKPT_PATH="/dataset/f1d6ea5b/gyx-eva/eva2/results/finetune_with_pretrain_0.00005_32_1_esc_merge_9_17_full/2800/"
RANKER_CKPT_PATH="/dataset/f1d6ea5b/wenjiaxin/ruber-pytorch/results/chinese-roberta-wwm-ext_dialog_0902_multiturn/lightning_logs/version_0/checkpoints/converted_epoch=1-step=12499.ckpt"
...
CMD="/opt/conda/bin/deepspeed -i cgpt-m0:5 --master_port 2445 --hostfile ${HOST_FILE} ${WORKING_DIR}/src/eva_interactive.py ${OPTS}"
echo ${CMD}
${CMD}
