...
WORKING_DIR=/dataset/f1d6ea5b/wenjiaxin/eva-origin/
...
RANKER_CKPT_PATH="/dataset/f1d6ea5b/wenjiaxin/ruber-pytorch/results/chinese-roberta-wwm-ext_dialog_0902_multiturn/lightning_logs/version_0/checkpoints/wtf_converted_epoch=1-step=12499.ckpt"
